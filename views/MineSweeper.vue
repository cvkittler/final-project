<template>
    ...
    >
        <div>
            ...
            <h3 v-if="!playing && (lost || win)" :key="highScore">
                High Score: {{ highScore }}
            </h3>
            <h4 v-if="!playing && (lost || win)" :key="plays">
...
export default {
    ...
    methods: {
        ...
        submitScore: function (score) {
            ...
            fetch("/apiMineSweeper/score", requestOptions)
